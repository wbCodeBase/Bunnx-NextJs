    ...
    return (
        <>
            ...
            <section className="border-t container mx-auto max-w-screen-lg xl:max-w-screen-xl px-4 md:px-6 py-8">
                ...
                {/* <h2 className='font-semibold text-orange-500 text-xl'>Our Technology Expertise</h2>
                <h4 className='font-semibold text-3xl my-2'>We leverage the latest technologies to deliver top-notch software solutions.</h4>
                <p className='text-lg gray-800 text-gray-800'>Whether you require a complex enterprise software solution or seamless software integration, we will convert your ideas into reality with our long-standing, industry-proven IT consulting and bespoke software development services.</p> */}
                ...
                <section className="flex flex-wrap justify-center md:gap-10 gap-5 py-2 my-6">
                    ...
                    <div className='lg:w-[46%] w-full'>
                        ...
                        <p className='mt-2 text-lg gray-800'>We leverage the latest technologies to deliver top-notch software solutions. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Assumenda illum repudiandae animi vitae ab dolore nam.</p> */}
